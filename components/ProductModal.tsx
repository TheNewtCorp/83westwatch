          ...
          <div className="md:w-1/2 w-full p-4 flex flex-col items-center">
            ...
            {product.images && product.images.length > 1 && (
              <div className="flex items-center justify-center space-x-2 mb-4">
                <button onClick={prevImage} className="text-white bg-[#bca68e]/50 hover:bg-[#bca68e] rounded-full p-2 transition-colors" aria-label="Previous image">
                ...
                <button onClick={nextImage} className="text-white bg-[#bca68e]/50 hover:bg-[#bca68e] rounded-full p-2 transition-colors" aria-label="Next image">
                   <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
