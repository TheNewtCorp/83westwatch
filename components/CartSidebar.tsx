...
const STRIPE_PUBLISHABLE_KEY = 'pk_test_51RXx09Q3JY1KkFhyTrzlBVzVcjddlmQQZetKo9S1AxdCKSfATlb8Qpp90rmLqwjo5D5UDWUwUEqUddsAwIwNNjkP000C2UqhoS';
  ...
  return (
    ...
    >
      ...
      >
        ...
        {checkoutError && (
          <div className="p-4 bg-red-700 text-red-100 text-sm text-center">
            {checkoutError}
          </div>
        )}
        ...
        {cartItems.length === 0 ? (
          <div className="flex-grow flex flex-col items-center justify-center p-6 text-center">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.2} stroke="currentColor" className="w-24 h-24 text-[#515052] mb-4">
                ...
                <div key={item.id} className="flex items-start space-x-4 p-3 bg-[#3B2620]/60 rounded-lg">
                  ...
                  >
                     <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5">
                        <path strokeLinecap="round" strokeLinejoin="round" d="M14.74 9l-.346 9m-4.788 0L9.26 9m9.968-3.21c.342.052.682.107 1.022.166m-1.022-.165L18.16 19.673a2.25 2.25 0 01-2.244 2.077H8.084a2.25 2.25 0 01-2.244-2.077L4.772 5.79m14.456 0a48.108 48.108 0 00-3.478-.397m-12.56 0c1.153 0 2.243.096 3.297.266M6.228 6.091A3.285 3.285 0 019.513 4.5h4.974c1.166 0 2.22.613 2.813 1.591m-5.462 2.193a48.068 48.068 0 01-3.478-.397m12.56 0a48.068 48.068 0 00-3.478-.397m-9.082 0l-.346 9M15 9l-.346 9m0 0a2.25 2.25 0 01-2.244 2.077H9.261a2.25 2.25 0 01-2.244-2.077L6.67 9M15 9H9" />
                    </svg>
                  </button>
                </div>
              ))}
